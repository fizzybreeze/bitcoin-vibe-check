...
async function fetchChart(days) {
  ...
  // Kraken reports its own errors in a 200 response, so this can throw.
  const candles = extractKrakenOhlc(json)
...
export default function App() {
  ...
  // calc200DMA reads index 4 (close), which is the same index in Kraken's shape
  // as it was in Binance's, so it consumes these candles unchanged.
  useEffect(() => {
    let active = true
